 ...
 */
final class Version20240429080229 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE agregat_carriere_saisie_debit (id INT AUTO_INCREMENT NOT NULL, type_article VARCHAR(255) NOT NULL, nombre_tonne VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE agregat_carriere_saisie_debit');
