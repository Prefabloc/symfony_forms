 ...
 */
final class Version20240605073746 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE signalement (id INT AUTO_INCREMENT NOT NULL, production_form_id INT NOT NULL, type VARCHAR(255) NOT NULL, message LONGTEXT NOT NULL, INDEX IDX_F4B551144AE316A0 (production_form_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE signalement ADD CONSTRAINT FK_F4B551144AE316A0 FOREIGN KEY (production_form_id) REFERENCES production_form (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE signalement DROP FOREIGN KEY FK_F4B551144AE316A0');
