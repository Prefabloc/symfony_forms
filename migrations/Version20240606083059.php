 ...
 */
final class Version20240606083059 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE agregat_carriere_production_chargeuse (id INT NOT NULL, mode VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE agregat_carriere_production_mobile (id INT NOT NULL, etage1 VARCHAR(255) DEFAULT NULL, etage2 VARCHAR(255) DEFAULT NULL, etage3 VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE agregat_carriere_production_pelle (id INT NOT NULL, mode VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE agregat_concassage_production_chargeuse (id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE agregat_concassage_production_pelle (id INT NOT NULL, mode VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, societe_id INT NOT NULL, reference VARCHAR(255) NOT NULL, label VARCHAR(255) NOT NULL, can_be_produced TINYINT(1) NOT NULL, stock DOUBLE PRECISION NOT NULL, type_article VARCHAR(255) DEFAULT NULL, INDEX IDX_23A0E66FCF77503 (societe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE btpproduction (id INT NOT NULL, saisie_production_id INT DEFAULT NULL, article_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_88D21879FC9887F6 (saisie_production_id), INDEX IDX_88D218797294869C (article_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE exforman_production_alimentation (id INT NOT NULL, mode VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE saisie_alimentation (id INT AUTO_INCREMENT NOT NULL, type_materiau_id INT NOT NULL, quantite INT NOT NULL, INDEX IDX_A8C0C3A850063EB (type_materiau_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE saisie_debit (id INT AUTO_INCREMENT NOT NULL, article_id INT NOT NULL, quantite INT NOT NULL, INDEX IDX_7E3BC2F07294869C (article_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE saisie_declassement (id INT AUTO_INCREMENT NOT NULL, motif_declassement_id INT NOT NULL, article_id INT NOT NULL, quantite VARCHAR(50) NOT NULL, INDEX IDX_438F8DE3AF30B184 (motif_declassement_id), INDEX IDX_438F8DE37294869C (article_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE saisie_destockage (id INT AUTO_INCREMENT NOT NULL, article_id INT NOT NULL, quantite INT NOT NULL, INDEX IDX_781D55187294869C (article_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE type_materiau (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE valromex_saisie_declassement (id INT AUTO_INCREMENT NOT NULL, article_id INT NOT NULL, motif_declassement_id INT NOT NULL, quantite INT NOT NULL, INDEX IDX_D1B20AA97294869C (article_id), INDEX IDX_D1B20AA9AF30B184 (motif_declassement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE agregat_carriere_production_pelle ADD CONSTRAINT FK_60A74E35BF396750 FOREIGN KEY (id) REFERENCES production_form (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE agregat_concassage_production_chargeuse ADD CONSTRAINT FK_AA6A3009BF396750 FOREIGN KEY (id) REFERENCES production_form (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE agregat_concassage_production_pelle ADD CONSTRAINT FK_982DD1B4BF396750 FOREIGN KEY (id) REFERENCES production_form (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE btpproduction ADD CONSTRAINT FK_88D21879BF396750 FOREIGN KEY (id) REFERENCES production_form (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE exforman_production_alimentation ADD CONSTRAINT FK_BEB101B0BF396750 FOREIGN KEY (id) REFERENCES production_form (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE saisie_alimentation ADD CONSTRAINT FK_A8C0C3A850063EB FOREIGN KEY (type_materiau_id) REFERENCES type_materiau (id)');
        $this->addSql('ALTER TABLE saisie_debit ADD CONSTRAINT FK_7E3BC2F07294869C FOREIGN KEY (article_id) REFERENCES article (id)');
        ...
        $this->addSql('ALTER TABLE saisie_declassement ADD CONSTRAINT FK_438F8DE37294869C FOREIGN KEY (article_id) REFERENCES article (id)');
        $this->addSql('ALTER TABLE saisie_destockage ADD CONSTRAINT FK_781D55187294869C FOREIGN KEY (article_id) REFERENCES article (id)');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649FCF77503 FOREIGN KEY (societe_id) REFERENCES societe (id)');
        $this->addSql('ALTER TABLE valromex_saisie_declassement ADD CONSTRAINT FK_D1B20AA97294869C FOREIGN KEY (article_id) REFERENCES article (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE agregat_carriere_production_chargeuse DROP FOREIGN KEY FK_7BCA1475BF396750');
        $this->addSql('ALTER TABLE agregat_carriere_production_mobile DROP FOREIGN KEY FK_7B271E42BF396750');
        $this->addSql('ALTER TABLE agregat_carriere_production_pelle DROP FOREIGN KEY FK_60A74E35BF396750');
        $this->addSql('ALTER TABLE agregat_concassage_production_chargeuse DROP FOREIGN KEY FK_AA6A3009BF396750');
        $this->addSql('ALTER TABLE agregat_concassage_production_pelle DROP FOREIGN KEY FK_982DD1B4BF396750');
        ...
        $this->addSql('ALTER TABLE btpproduction DROP FOREIGN KEY FK_88D21879BF396750');
        $this->addSql('ALTER TABLE exforman_production_alimentation DROP FOREIGN KEY FK_BEB101B0BF396750');
        ...
        $this->addSql('ALTER TABLE saisie_alimentation DROP FOREIGN KEY FK_A8C0C3A850063EB');
        $this->addSql('ALTER TABLE saisie_debit DROP FOREIGN KEY FK_7E3BC2F07294869C');
        $this->addSql('ALTER TABLE saisie_declassement DROP FOREIGN KEY FK_438F8DE3AF30B184');
        $this->addSql('ALTER TABLE saisie_declassement DROP FOREIGN KEY FK_438F8DE37294869C');
        $this->addSql('ALTER TABLE saisie_destockage DROP FOREIGN KEY FK_781D55187294869C');
        $this->addSql('ALTER TABLE user DROP FOREIGN KEY FK_8D93D649FCF77503');
        $this->addSql('ALTER TABLE valromex_saisie_declassement DROP FOREIGN KEY FK_D1B20AA97294869C');
        ...
        $this->addSql('DROP TABLE motif_declassement');
        $this->addSql('DROP TABLE prefabloc_production');
        $this->addSql('DROP TABLE production_form');
        ...
        $this->addSql('DROP TABLE type_materiau');
