 ...
 */
final class Version20240528100851 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prefabloc_production (id INT AUTO_INCREMENT NOT NULL, article_id INT DEFAULT NULL, started_at DATETIME NOT NULL, ended_at DATETIME DEFAULT NULL, INDEX IDX_6D5A99447294869C (article_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE saisie_production (id INT AUTO_INCREMENT NOT NULL, production_id INT DEFAULT NULL, qte04 DOUBLE PRECISION NOT NULL, qte610 DOUBLE PRECISION NOT NULL, qte_cem DOUBLE PRECISION NOT NULL, qte_adjuvant DOUBLE PRECISION NOT NULL, qte_huile DOUBLE PRECISION NOT NULL, qte_eau DOUBLE PRECISION NOT NULL, UNIQUE INDEX UNIQ_291C8794ECC6147F (production_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE saisie_production ADD CONSTRAINT FK_291C8794ECC6147F FOREIGN KEY (production_id) REFERENCES prefabloc_production (id)');
