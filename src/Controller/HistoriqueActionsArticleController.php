...
class HistoriqueActionsArticleController extends AbstractController
{
    ...
    public function addHistorique(Request $request, EntityManagerInterface $entityManager, ArticleRepository $articleRepository): Response
    {
        $user = $this->getUser();
    ...
    public function removeHistorique(Request $request, EntityManagerInterface $entityManager, ArticleRepository $articleRepository): Response
    {
        $user = $this->getUser();
